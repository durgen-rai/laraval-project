    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="email" id="email" name="email" placeholder="Email" class="col-xs-10 col-sm-5" value="{{ old('email') }}">
            @if($errors->has('email'))
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="password" id="password" name="password" placeholder="Password" class="col-xs-10 col-sm-5" value="{{ old('password') }}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="full_name" name="full_name" placeholder="Full Name" class="col-xs-10 col-sm-5" value="{{ old('full_name') }}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="contact_no" name="contact_no" placeholder="Mobile No" class="col-xs-10 col-sm-5" value="{{ old('contact_no') }}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea rows="3" class="col-xs-10 col-sm-5" id="address" name="address" >{{ old('address') }}</textarea>
    ...
    <div class="control-group">
        ...
        <div class="radio">
            <label>
                <input name="status" type="radio" class="ace"  value="active" checked>
