...
<script src="{{asset('admin-panel/assets/js/jquery.easypiechart.min.js')}}"></script>
<script src="{{asset('admin-panel/assets/js/jquery.sparkline.index.min.js')}}"></script>
<script src="{{asset('admin-panel/assets/js/jquery.flot.min.js')}}"></script>
<script src="{{asset('admin-panel/assets/js/jquery.flot.pie.min.js')}}"></script>
<script src="{{asset('admin-panel/assets/js/jquery.flot.resize.min.js')}}"></script>
